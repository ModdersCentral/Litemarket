...
if (!medium_checkloggedin(true)){header("Location: ./index.php");exit();}
	...
	if (isset($_POST['dfsdgs'])){
	if(preg_match('/^[0-9]{1,5}(?:\.[0-9]{2}){0,1}$/',$_POST['setmyprice'])){
	echo 'price OK';
	}else{
	echo 'price error';
	}
								...
								<div class="navbar-header">
									...
									<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav">
											...
											<li class="active"><a href="./create.php">Create Product</a></li>
...
<div class="container">
	...
	<form method="post" action="./create.php">
     Product title:   <input type="text" name="fname"    title="Has to be at least 20 characters long. But not over 60 characters. e.g Pizza"  pattern="^[a-zA-Z0-9]{20,60}$" required data-errormessage-value-missing="Something's missing" data-errormessage-type-mismatch="Invalid!" ><br />
	 Product short description:   <input type="text"   title="e.g 10 packs x 10.. 2 bags... 2 boxes"  name="fname"  pattern="[^\s]*"  required data-errormessage-value-missing="Something's missing" data-errormessage-type-mismatch="Invalid!"  > <br />
	 Product full description:   (e.g something to drag buyers in)<br />
	 <textarea rows="4" cols="50"></textarea><br />
	 Price in USD :  $<input type="number" name="currency" min="11.00" max="9999" step="0.01" value="11.00" required data-errormessage-value-missing="Something's missing" data-errormessage-type-mismatch="Invalid!" />(over $11.00 please)<br/>
	 Ships From: 
